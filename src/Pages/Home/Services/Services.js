    ...
    <div className="max-w-screen-lg mx-auto my-8">
      ...
      >
        {services.map(({ id, title, icon }) => (
          <div
            key={id}
            className="shadow-md hover:scale-105 duration-500 py-8 rounded-lg shadow-black flex items-center justify-evenly bg-teal-400"
          >
            <span className="text-4xl bg-teal-200 p-3 rounded-full">
              {icon}
            </span>
